                ...
                <div className="w-full">
                    {!croppedImage ? (
                        ...
                        <div className="relative group w-full">
                            <img src={croppedImage} alt="Your cropped photo" className="rounded-xl shadow-lg shadow-[var(--color-shadow-primary)]/20 object-cover w-full" style={{ aspectRatio: croppedImageAspectRatio }} />
