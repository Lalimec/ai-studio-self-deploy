...
const Lightbox: React.FC<LightboxProps> = ({ images, currentIndex, setCurrentIndex, onClose, mode = 'hairStudio' }) => {
  ...
  return (
    <div 
      ...
      onClick={onClose}
    >
      <div className="relative flex items-center justify-center p-4 sm:p-8" onClick={e => e.stopPropagation()}>
        ...
        {/* Previous Button */}
         {images.length > 1 && (
            <button
                ...
                className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--color-text-main)] bg-black bg-opacity-50 rounded-full p-2 hover:bg-opacity-75 transition-colors"
        ...
        {images.length > 1 && (
            <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--color-text-main)] bg-black bg-opacity-50 rounded-full p-2 hover:bg-opacity-75 transition-colors"
