            ...
            `}</style>
                ...
                <div className="w-full flex gap-1 mb-3">
                    <button
                        ...
                        className={`arch-tooltip flex-1 py-2 px-2 text-xs font-semibold rounded-md transition-colors ${selectedVersion === 'real'
                    ...
                    {transformationTypes.map(({ id, label, icon, tooltip }) => {
                        ...
                        return (
                            <button
                                ...
                                className={`arch-tooltip flex-1 py-2 px-2 text-xs font-semibold rounded-md transition-colors relative ${selectedVersion === id
                                    ? 'bg-[var(--color-primary)] text-[var(--color-text-on-primary)]'
                                    : 'bg-[var(--color-bg-muted)] text-[var(--color-text-main)] hover:bg-[var(--color-bg-muted-hover)]'
                                    }`}
                            >
