...
interface MultiCropViewProps {
    files: File[];
    onConfirm: (croppedFiles: File[], aspectRatio: number) => void;
    onCancel: () => void;
}
...
export const MultiCropView: React.FC<MultiCropViewProps> = ({ files, onConfirm, onCancel }) => {
    ...
    return (
        <div className="fixed inset-0 bg-[var(--color-bg-base)] bg-opacity-80 z-50 p-4 sm:p-6 lg:p-8 flex flex-col animate-fade-in">
